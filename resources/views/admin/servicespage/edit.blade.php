                    ...
                    <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2">
                        <form action="{{route('servicespage.store')}}" method="POST" class="needs-validation" enctype="multipart/form-data">    
                            ...
                            <div class="card-header">
                                <h4><i class="fa fa-servicestack"></i>Services Edit</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        <label>Technologies</label>
                                        <input type="text" class="form-control" value="{{(isset($home_page->name)? $home_page->name : '')}}" name="technologies">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        <label>Slug</label>
                                        <input type="text" class="form-control" value="{{(isset($home_page->designation)? $home_page->designation : '')}}" name="slug">                                
                                        <div class="invalid-feedback">
